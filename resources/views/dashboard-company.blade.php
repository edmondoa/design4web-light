...
<div id="info" style="padding:10px;width:300px;">
	...
	<h3>Hi {{ $info->company_name}}!</h3>
	@endforeach
	
</div>
	<div style="width:100%; height:5px;"></div>
<div style="border:1px solid #f4f4f4;padding:10px;width:350px;min-height:400px;float:left;margin-right:10px;">
	<h5 style="width:100%; background-color:#f4f4f4;padding:5px;">Employees</h5>
	<ul>
		@foreach($employees as $employees)
		<li>{{$employees->employee_name}}</li>
		@endforeach
	</ul>
...
<div style="border:1px solid #f4f4f4;padding:10px;width:350px;min-height:400px;float:left;margin-right:10px;">
	<h5 style="width:100%; background-color:#f4f4f4;padding:5px;">Measures</h5>
	<ul>
		@foreach($measure as $measure)
		<li>{{ $measure->measure_a}} - {{ $measure->target_a}}</li>
		<li>{{ $measure->measure_b}} - {{ $measure->target_b}}</li>
		<li>{{ $measure->measure_c}} - {{ $measure->target_c}}</li>
		@endforeach
	</ul>
